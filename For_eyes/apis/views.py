...
def create_checkout_session(request):
    ...
    try:
        checkout_session = stripe.checkout.Session.create(
            ...
            mode='payment',
            success_url=f"http://localhost:3000/payment-success?session_id={{CHECKOUT_SESSION_ID}}&order_id={order.id}",
            cancel_url=f"http://localhost:3000/payment-cancel?order_id={order.id}",
